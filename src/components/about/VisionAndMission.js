...
const VisionAndMission = () => {
  const data = [
    ...
    },
    {
      ...
      content: [
        ...
        "By harnessing our extensive experience and embracing emerging trends, we empower businesses to thrive in an ever-evolving payment landscape.",
        ...
        <div className="overflow-hidden bg-white rounded shadow-md text-slate-500 shadow-slate-200 flex-grow">
          ...
          <div className="p-6 flex flex-col gap-3">
            ...
            {card.content.map((paragraph, idx) => {
              return (
                <p key={idx} className={"xl:text-xl"}>
                  {paragraph}
                </p>
              );
            })}
  ...
  return (
    <section>
      <Heading title={"Our Goals & Ambitions"} />
